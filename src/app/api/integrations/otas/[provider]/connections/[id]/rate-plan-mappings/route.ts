...
export async function GET(
  ...
  try {
    ...
    const mappings = await reservationStore.listOtaRatePlanMappings(connectionId);
...
export async function POST(
  ...
  try {
    ...
    const mapping = await reservationStore.upsertOtaRatePlanMapping(connectionId, payload);
